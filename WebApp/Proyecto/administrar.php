...
try {
  ...
  if (isset($_POST['apellido'])) {
    $consultaSQL = "SELECT * FROM vendedores WHERE apellido LIKE '%" . $_POST['apellido'] . "%'";
  } else {
...
$titulo = isset($_POST['apellido']) ? 'Lista de vendedores (' . $_POST['apellido'] . ')' : 'Lista de vendedores';
?>
  ...
  <div class="row">
    <div class="col-md-12">
      ...
      <table class="table">
        ...
        <tbody>
          <?php
          if ($vendedores && $sentencia->rowCount() > 0) {
