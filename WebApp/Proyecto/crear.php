...
if (isset($_POST['submit'])) {
  ...
  try {
    ...
    $consultaSQL = "INSERT INTO vendedores (nombre, apellido, email, edad)";
...
<div class="container">
  <div class="row">
    <div class="col-md-12">
      <h2 class="mt-4">Crea un nuevo vendedor</h2>
      <hr>
      <form method="post">
        ...
        <div class="form-group">
          ...
          <a class="btn btn-primary" href="administrar.php">Volver</a>
        </div>
      </form>
    </div>
  </div>
